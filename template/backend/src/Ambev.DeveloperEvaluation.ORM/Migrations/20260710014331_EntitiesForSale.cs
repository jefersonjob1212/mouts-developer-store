...
{
    /// <inheritdoc />
    public partial class EntitiesForSale : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClientType = table.Column<string>(type: "character varying(13)", maxLength: 13, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Sales_Subsidiaries_SubsidiaryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Sales_SubsidiaryId",
                table: "Sales",
                column: "SubsidiaryId");

            migrationBuilder.CreateIndex(
                name: "IX_Subsidiaries_TradeName",
                table: "Subsidiaries",
                column: "TradeName");
        }
